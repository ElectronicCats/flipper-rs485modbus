...
void app_scene_sniffer_on_enter(void* context) {
  ...
  if (scene_manager_get_scene_state(app->sceneManager, app_scene_sniffer) ==
          Sniffer_Option ||
      scene_manager_get_scene_state(app->sceneManager, app_scene_sniffer  ) ==
          Sender_Option) {
    ...
    furi_string_cat_printf(app->text, "\nResponse TimeOut: %dms",
                 ...
                 app->sceneManager, app_scene_sniffer) == About_Option) {
    text_box_set_font(app->textBox, TextBoxFontText);
